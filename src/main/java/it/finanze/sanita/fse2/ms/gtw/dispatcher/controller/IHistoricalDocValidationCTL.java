...
public interface IHistoricalDocValidationCTL {
	...
	@ApiResponse(content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = HistoricalValidationCDAResDTO.class)))
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Validazione eseguita senza inserimento in cache", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ValidationCDAResDTO.class))),
	...
	HistoricalValidationCDAResDTO historicalValidationCDA(
			@RequestBody(required = false) HistoricalValidationCDAReqDTO requestBody,
