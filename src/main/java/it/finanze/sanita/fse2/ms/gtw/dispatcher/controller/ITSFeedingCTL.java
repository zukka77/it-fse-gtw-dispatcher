...
public interface ITSFeedingCTL {
	...
	@Operation(summary = "Validazione e Pubblicazione documenti ricevuti da TS", description = "Valida e Pubblica un documento ricevuto da Tessera Sanitaria.", security = @SecurityRequirement(name = "bearerAuth"))
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Validazione e Pubblicazione su EDS eseguite con successo", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ValidationCDAResDTO.class))),
