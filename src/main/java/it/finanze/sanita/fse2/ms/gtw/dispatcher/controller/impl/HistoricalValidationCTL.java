...
// 		if(StringUtility.isNullOrEmpty(msgResult)){
// 			kafkaSRV.sendHistoricalValidationStatus(transactionId, EventStatusEnum.SUCCESS, null, jsonObj, jwtToken != null ? jwtToken.getPayload() : null);
//         } else {
// 			kafkaSRV.sendHistoricalValidationStatus(transactionId, EventStatusEnum.ERROR, msgResult, jsonObj, jwtToken != null ? jwtToken.getPayload() : null);
//         }
...
// 		return new HistoricalValidationCDAResDTO(getLogTraceInfo(), transactionId);
// 	}
