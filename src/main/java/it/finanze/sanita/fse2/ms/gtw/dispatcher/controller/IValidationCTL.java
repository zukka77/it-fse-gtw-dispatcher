...
public interface IValidationCTL {
	...
	ResponseEntity<ValidationCDAResDTO> validationCDA(@RequestBody(required=false) ValidationCDAReqDTO requestBody, @RequestPart("file") MultipartFile file, HttpServletRequest request);
