...
public interface IHistoricalDocPublicationCTL {
	...
	@PostMapping(value = "/historical-publish-creation", consumes = {"multipart/form-data"})
	@Operation(summary = "Pubblicazione creazione documenti pregressi", description = "Pubblica documenti pregressi con l'intento di generare nuove risorse FHIR.",
	...
	PublicationCreationResDTO historicalDocPublicationCreation(@RequestBody(required=false) PublicationCreationReqDTO requestBody, @RequestPart("file") MultipartFile file , HttpServletRequest request);
